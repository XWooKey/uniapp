			...
			<view class='cell-group'>
				...
				<view class='price-salesvolume' v-if="lasttime.hour!==false">
					...
					<view class='commodity-time'>
						<text>距结束仅剩</text>
						<view class='commodity-day'><uni-countdown :show-day="false" :hour="lasttime.hour" :minute="lasttime.minute" :second="lasttime.second"></uni-countdown></view>
					</view>
					<!-- <view class='commodity-time'>
						已结束
					</view> -->
